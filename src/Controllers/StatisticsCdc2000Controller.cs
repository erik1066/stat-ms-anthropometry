...
{
    [Route("api/1.0/cdc2000")]
    [ApiController]
    public sealed class StatisticsCdc2000Controller : ControllerBase
    {
        private static CDC2000 _cdcReference = new CDC2000();

        public StatisticsCdc2000Controller()
        {
        }
